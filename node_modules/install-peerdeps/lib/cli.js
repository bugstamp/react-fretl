...
if (program.args.length > 1) {
  console.log(`${C.errorText} Please specify only one package at a time to install with peerDeps.`);
  process.exit(1);
}
...
function installCb(err) {
  ...
  var successMessage = `${C.successText} ${packageName} and its peerDeps were installed successfully.`;
