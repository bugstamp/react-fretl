...
var AvRadio = function (_Component) {
  ...
  AvRadio.prototype.render = function render() {
    ...
    var classes = (0, _classnames2.default)(className, this.context.FormCtrl.isTouched[this.props.name] ? 'av-touched' : 'av-untouched', this.context.FormCtrl.isDirty[this.props.name] ? 'av-dirty' : 'av-pristine', this.context.FormCtrl.hasError[this.props.name] ? 'av-invalid' : 'av-valid');

    return _react2.default.createElement(
      _reactstrap.FormGroup,
      { check: true, inline: this.context.Group.inline, disabled: this.props.disabled },
