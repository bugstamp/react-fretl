...
var AvForm = function (_InputContainer) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                _this.setTouched((0, _keys2.default)(_this._inputs));
  ...
  AvForm.prototype.getValues = function getValues() {
    ...
    return (0, _keys2.default)(this._inputs).reduce(function (values, inputName) {
      (0, _set3.default)(values, inputName, _this3.getValue(inputName));
  ...
  AvForm.prototype.validateInput = function () {
    var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(name) {
  ...
  AvForm.prototype.validateOne = function () {
    var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(inputName, context) {
  ...
  AvForm.prototype.validateAll = function () {
    var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(context) {
  ...
  AvForm.prototype.compileValidationRules = function compileValidationRules(input, ruleProp) {
    ...
    return function () {
      var _ref6 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(val, context) {
                ...
                return _promise2.default.all(validations).then(function (results) {
                  results.every(function (ruleResult) {
                    if (result === true && ruleResult.value !== true) {
                      result = (0, _isString2.default)(ruleResult.value) && ruleResult.value || getInputErrorMessage(input, ruleResult.rule) || getInputErrorMessage(_this5, ruleResult.rule) || false;
                    }
                    return result === true;
                  });
                });
